...
import Header from "@/ui-modules/home/Header/Header"
		...
		<div style={{ background: "#222" }}>
			...
			<section data-service className={styles.service}>
				<div className={styles.container}>
					<div
						...
						style={{ paddingRight: "var(--title-pl)" }}
					>
						<h1>Enjoy on your Tv.</h1>
						<h2>
							Watch on Smart Tvs, Playstation, Xbox, Chromecast,
							Apple Tv, Blue-ray players, and more,
						</h2>
					</div>
			...
			<section data-service className={styles.service}>
				<div className={styles.container}>
					<div
						className={styles.serviceTitle}
						style={{ paddingLeft: "var(--title-pl)" }}
					>
						<h1>Download your shows to watch offline</h1>
						<h2>
							Save your favorites easly and always have something
							to watch
						</h2>
					</div>
			...
			<section data-service className={styles.service}>
				<div className={styles.container}>
					<div
						className={styles.serviceTitle}
						style={{ paddingRight: "var(--title-pr)" }}
					>
