            ...
            <div className={styles.container}>
                ...
                <div className={styles.login}>
                    <div className={styles.container}>
                        ...
                        <form onSubmit={()=>{console.log("Something")}} className={styles.loginForm}>
                            <Input value="jonhndoe@domain.com" placeholder="Email or phone number" disabled/>
                            <Input value="jodhndoe@domain.com" placeholder="Password" type="password" disabled/>
                        ...
                        <div className={styles.loginSettings}>
                            <div className={styles.checkboxContainer}>
                                ...
                                <label for="remember-me" className={styles.checkBoxLabel}>
